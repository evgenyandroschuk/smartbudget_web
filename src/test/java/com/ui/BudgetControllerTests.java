...
/**
 * A Basic Spring MVC Test for the Sample BudgetController"
 * 
...
@WebAppConfiguration
@ContextConfiguration(classes = SmartBudgetWebUiApplication.class)
public class BudgetControllerTests {
	...
	public void testHome() throws Exception {
		this.mockMvc.perform(get("/")).andExpect(status().isOk())
				.andExpect(content().string(containsString("<title>Главная страница")));
	}

	@Test
	public void testExpenses() throws Exception {
		this.mockMvc.perform(get("/expenses")).andExpect(status().isOk())
				.andExpect(content().string(containsString("<title>Расходы")));
	}

	@Test
	public void testAddExpenses() throws Exception {
		this.mockMvc.perform(get("/expenses/form")).andExpect(status().isOk())
